...
namespace CustomSupportLogger.Controllers
{
    public class CustLogInfoesController : Controller
    {
        ...
        public CustLogInfoesController(Phase4Context context)
        {
            _context = context;
        }
        ...
        {
            var phase4Context = _context.CustLogInfos.Include(c => c.User);
            return View(await phase4Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Phase4Context.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
